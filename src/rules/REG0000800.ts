...
export const REG0000800: Rule = (iv) => {
    ...
    // #3
    // COND:
    // §FS_DIM_250 = §SI AND §FS_BRA_CIN = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // #4
    // COND:
    // §FS_COMBI_250 = §SI AND §FS_BRA_CIN = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // #5
    // COND:
    ...
    //#3
    if (vars.get('§FS_DIM_250') == vars.get('§SI') && vars.get('§FS_BRA_CIN') == vars.get('§SI')) {
        vars.setDUMMYB1(vars.get('§SI'));
    }
    
    //#4
    if (vars.get('§FS_COMBI_250') == vars.get('§SI') && vars.get('§FS_BRA_CIN') == vars.get('§SI')) {
        vars.setDUMMYB1(vars.get('§SI'));
    }
