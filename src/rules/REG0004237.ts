...
export const REG0004237: Rule = (iv) => {
    ...
    //#17
    if ((vars.get('§TI_ACC_TWI') == '02') && (vars.get('§LA_ADD_LAT') == 'SX') && ((vars.get('§L_SBA_POS2') > 0) || (vars.get('§L_SPO_MON_POS2') > 0) || (vars.get('§FS_MON_POS_2') != vars.get('§SI'))) && (vars.get('§FS_STA_MUR_ANT1') == vars.get('§SI'))) {
        vars.setCF(0);
    }
    //#18
    ...
    //#26
    if ((vars.get('§FS_ACC_FIN') == vars.get('§SI')) && (vars.get('§FS_ACC_POS_ANT') == vars.get('§SI')) && (((vars.get('§L_SPO_MON_POS2') == 0) && (vars.get('§L_SBA_POS2') == 0) && (vars.get('§FS_MON_POS_2') == vars.get('§SI'))) || ((vars.get('§L_SPO_MON_POS1') == 0) && (vars.get('§L_SBA_POS1') == 0) && (vars.get('§FS_MON_POS_1') == vars.get('§SI'))))) {
        vars.setCF(1);
    }
    //#27
    ...
    //#28
   // if ((vars.get('§FS_ACC_FIN') == vars.get('§SI')) && (vars.get('§FS_ACC_POS_ANT') == vars.get('§SI')) && (vars.get('§TI_ACC_TWI') == '02') && (vars.get('§L_SPO_MON_ANT2') == 0) && (vars.get('§L_SBA_ANT2') == 0) && (vars.get('§FS_MON_ANT2') ==
    // GENERATED
