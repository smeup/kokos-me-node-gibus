...
export const REG0004703: Rule = (iv) => {
    ...
    // #2
    // COND:
    // (§FS_ACC_CEN=§SI ) AND (§TI_ACC_TWI='01' ) AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CON-A=*COL
    // *SET *CON-B=*LUNG
    // *SET *S2=*LUNG
    // #3
    // COND:
    // (§FS_ACC_FIN=§SI ) AND (§TI_ACC_TWI='01' ) AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CF=#0
    // #4
    // COND:
    ...
    // #5
    // COND:
    // (§FS_FAM2_ISOLA=§SI ) AND (§FS_ACC_CEN=§SI ) AND (§TI_ACC_TWI='02') AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CON-A=*COL
    // *SET *CON-B=*LUNG
    // *SET *S2=*LUNG
    ...
    // #12
    // COND:
    // ( §FS_FAM2_ADDL=§SI ) AND (§TI_ACC_TWI='01') AND (§FS_ACC_CEN=§SI ) AND (§LA_ADD_LAT='DX')
    // THEN:
    // *SET *CON-A=*COL
    // *SET *CON-B=*LUNG
    // *SET *S2=*LUNG
    ...
    //#2
    if ((vars.get('§FS_ACC_CEN') == vars.get('§SI')) && (vars.get('§TI_ACC_TWI') == '01') && (vars.get('§FS_ACC_DX_SX') == vars.get('§SI'))) {
        vars.setCON_A(vars.getCOL());
        vars.setCON_B(vars.getLUNG());
        vars.setS2(vars.getLUNG());
    }
    ...
    //#3
    if ((vars.get('§FS_ACC_FIN') == vars.get('§SI')) && (vars.get('§TI_ACC_TWI') == '01') && (vars.get('§FS_ACC_DX_SX') == vars.get('§SI'))) {
        vars.setCF(0);
    }
    ...
    //#5
    if ((vars.get('§FS_FAM2_ISOLA') == vars.get('§SI')) && (vars.get('§FS_ACC_CEN') == vars.get('§SI')) && (vars.get('§TI_ACC_TWI') == '02') && (vars.get('§FS_ACC_DX_SX') == vars.get('§SI'))) {
        vars.setCON_A(vars.getCOL());
        vars.setCON_B(vars.getLUNG());
        vars.setS2(vars.getLUNG());
    }
    ...
    //#12
    if ((vars.get('§FS_FAM2_ADDL') == vars.get('§SI')) && (vars.get('§TI_ACC_TWI') == '01') && (vars.get('§FS_ACC_CEN') == vars.get('§SI')) && (vars.get('§LA_ADD_LAT') == 'DX')) {
        vars.setCON_A(vars.getCOL());
        vars.setCON_B(vars.getLUNG());
        vars.setS2(vars.getLUNG());
    }
