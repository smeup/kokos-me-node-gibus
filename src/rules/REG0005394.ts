...
export const REG0005394: Rule = (iv) => {
    ...
    // #1
    // COND:
    // *SET *CF = #0                                                                                                                *SET §DUMMYB1 = ''                                                                                                           *SET §DUMMYB2 = ''                                                                                                           *SET *CON-A = §VERN_1_COM
    // #2
    // COND:
    // §FS_STA_MUR_POS1 = §SI
    // THEN:
    ...
    // #7
    // COND:
    // §FS_MON_POS_1 = §SI AND §FS_ACC_LAT_POS <> §SI AND §FS_ACC_LAT_SX <> §SI
    // THEN:
    // *SET *CF = #0
    // #8
    // THEN:
    ...
    // #9
    // COND:
    // §FS_MON_POS_1 = §SI AND §TI_PR_POS1 = '01'
    // THEN:
    // *SET *CON-B = #30,5
    // #10
    // COND:
    ...
    //#7
    if (vars.get('§FS_MON_POS_1') == vars.get('§SI') && vars.get('§FS_ACC_LAT_POS') != vars.get('§SI') && vars.get('§FS_ACC_LAT_SX') != vars.get('§SI')) {
        vars.setCF(0);
    }
    ...
    //#9
    if (vars.get('§FS_MON_POS_1') == vars.get('§SI') && vars.get('§TI_PR_POS1') == '01') {
        vars.setCON_B(30.5);
    }
