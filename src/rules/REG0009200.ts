...
export const REG0009200: Rule = (iv) => {
    ...
    if (vars.get('§FS_FAM2_TWIST') == vars.get('§SI')) {
        ...
        vars.setDUMMYN1(vars.get('#40,6') - vars.get('#0,3'));
        vars.setDUMMYN2(vars.get('#40,6') - vars.get('#0,3'));
        vars.setDUMMYN3(vars.get('#40,6') - vars.get('#0,3'));
    }
    
    //#4
    if (vars.get('§FS_FAM2_VARIA') == vars.get('§SI')) {
        vars.setDUMMYB1(vars.get('§SI'));
        vars.setDUMMYN1(vars.get('#54,3') - vars.get('#1,3'));
        vars.setDUMMYN2(vars.get('#50') - vars.get('#1,3'));
        vars.setDUMMYN3(vars.get('#45,7') - vars.get('#1,3'));
    }
