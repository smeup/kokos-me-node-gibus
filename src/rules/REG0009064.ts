...
export const REG0009064: Rule = (iv) => {
    ...
    // #3
    // COND:
    // §FS_FAM2_ZENIT = §SI AND §FS_LED_RGB_SX = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // *SET §DUMMYN1 = #30,9
    // *SET §DUMMYN2 = #30,9
    ...
    // #5
    // COND:
    // §FS_FAM2_TWIST = §SI AND §FS_LED_RGB_SX = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // *SET §DUMMYN1 = #20
    // *SET §DUMMYN2 = #20
    ...
    vars.setDUMMYB1('');
    //#3
    if (vars.get('§FS_FAM2_ZENIT') == vars.get('§SI') && vars.get('§FS_LED_RGB_SX') == vars.get('§SI')) {
    ...
    //#5
    if (vars.get('§FS_FAM2_TWIST') == vars.get('§SI') && vars.get('§FS_LED_RGB_SX') == vars.get('§SI')) {
        vars.setDUMMYB1(vars.get('§SI'));
        vars.setDUMMYN1(20);
        vars.setDUMMYN2(20);
        vars.setDUMMYN3(20);
