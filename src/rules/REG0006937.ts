...
export const REG0006937: Rule = (iv) => {
    ...
    // #3
    // COND:
    // §FS_MAR_30_13 = §SI OR §FS_MAR_35_13 = §SI OR §FS_MAR_30_50 = §SI
    // THEN:
    // *SET *CF = #1
    // #4
    // COND:
    // §FS_COMBI_250 = §SI §FS_COMBI_60 = §SI
    // THEN:
    // *SET *CF = #1
    // #5
    // COND:
    ...
    //#3
    if (vars.get('§FS_MAR_30_13') == vars.get('§SI') || vars.get('§FS_MAR_35_13') == vars.get('§SI') || vars.get('§FS_MAR_30_50') == vars.get('§SI')) {
        vars.setCF(1);
    }
