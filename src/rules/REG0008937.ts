...
export const REG0008937: Rule = (iv) => {
    ...
    // #3
    // COND:
    // §FS_FAM2_ZENIT = §SI AND §FS_LED_RGB_FRB = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // *SET §DUMMYN1 = #45,8
    // *SET §DUMMYN2 = #45,8
    ...
    // #5
    // COND:
    // §FS_FAM2_TWIST = §SI AND §FS_LED_RGB_FRB = §SI
    // THEN:
    // *SET §DUMMYB1 = §SI
    // *SET §DUMMYN1 = #40,6
    // *SET §DUMMYN2 = #40,6
    ...
    vars.setDUMMYB1('');
    //#3
    if (vars.get('§FS_FAM2_ZENIT') == vars.get('§SI') && vars.get('§FS_LED_RGB_FRB') == vars.get('§SI')) {
    ...
    //#5
    if (vars.get('§FS_FAM2_TWIST') == vars.get('§SI') && vars.get('§FS_LED_RGB_FRB') == vars.get('§SI')) {
        vars.setDUMMYB1(vars.get('§SI'));
