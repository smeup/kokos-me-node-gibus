...
export const REG0005408: Rule = (iv) => {
    ...
    // #7
    // COND:
    // §FS_MON_POS_2 = §SI AND §FS_ACC_LAT_POS <> §SI AND §FS_ACC_LAT_DX <> §SI
    // THEN:
    // *SET *CF = #0
    // #8
    // THEN:
    ...
    // #9
    // COND:
    // §FS_MON_POS_2 = §SI AND §TI_PR_POS2 = '01'
    // THEN:
    // *SET *CON-B = #30,5
    // #10
    // COND:
    ...
    //#7
    if (vars.get('§FS_MON_POS_2') == vars.get('§SI') && vars.get('§FS_ACC_LAT_POS') != vars.get('§SI') && vars.get('§FS_ACC_LAT_DX') != vars.get('§SI')) {
        vars.setCF(0);
    }
    ...
    //#9
    if (vars.get('§FS_MON_POS_2') == vars.get('§SI') && vars.get('§TI_PR_POS2') == '01') {
        vars.setCON_B(30.5);
    }
    
    //#10
    if (vars.get('§FS_PO_AGG_MUR2') == vars.get('§SI')) {
        vars.setCON_B(30.5);
    }
