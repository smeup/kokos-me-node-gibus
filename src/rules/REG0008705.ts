...
export const REG0008705: Rule = (iv) => {
    ...
    // THEN:
    // *SET *CON-A = §VR_LAME
    // *SET *CF = [§NR_FRANGI - §NR_FRANGI_LED - §NR_FRA_STE - §NR_LAM_FAN]
    // #2
    // COND:
    // §FS_FAM2_JOY = §SI
    // THEN:
    ...
    vars.setCF(vars.get('§NR_FRANGI') - vars.get('§NR_FRANGI_LED') - vars.get('§NR_FRA_STE') - vars.get('§NR_LAM_FAN'));
