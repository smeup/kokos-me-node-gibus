...
export const REG0005257: Rule = (iv) => {
    ...
    // #3
    // COND:
    // (§FS_ACC_LAT=§SI ) AND (§FS_ACC_PRI=§SI ) AND (§FS_ACC_DX_SX=§SI ) AND ((§FS_SCA_MON_ANT2<>§SI ) OR (§FS_SCA_MON_POS2<>§SI))
    // THEN:
    // *SET *CF=#1
    // #4
    // COND:
    // (§FS_ACC_LAT=§SI ) AND (§FS_ACC_PRI=§SI ) AND (§FS_ACC_DX_SX=§SI ) AND ((§FS_SCA_MON_ANT2<>§SI ) AND (§FS_SCA_MON_POS2<>§SI))
    // THEN:
    // *SET *CF=#2
    // #5
    // COND:
    // (§FS_ACC_LAT=§SI ) AND (§FS_ACC_PRI=§SI ) AND (§FS_ACC_SX_DX=§SI ) AND ((§FS_SCA_MON_ANT1<>§SI ) OR (§FS_SCA_MON_POS1<>§SI ))
    // THEN:
    // *SET *CF=#1
    // #6
    // COND:
    // (§FS_ACC_LAT=§SI ) AND (§FS_ACC_PRI=§SI ) AND (§FS_ACC_SX_DX=§SI ) AND ((§FS_SCA_MON_ANT1<>§SI) AND (§FS_SCA_MON_POS1<>§SI ))
    // THEN:
    // *SET *CF=#2
    // #7
    // COND:
    ...
    //#3
    if ((vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_PRI') == vars.get('§SI')) && (vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT2') != vars.get('§SI')) || (vars.get('§FS_SCA_MON_POS2') != vars.get('§SI')))) {
        vars.setCF(1);
    }
    //#4
    if ((vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_PRI') == vars.get('§SI')) && (vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT2') != vars.get('§SI')) && (vars.get('§FS_SCA_MON_POS2') != vars.get('§SI')))) {
    ...
    //#5
    if ((vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_PRI') == vars.get('§SI')) && (vars.get('§FS_ACC_SX_DX') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT1') != vars.get('§SI')) || (vars.get('§FS_SCA_MON_POS1') != vars.get('§SI')))) {
        vars.setCF(1);
    }
    //#6
    if ((vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_PRI') == vars.get('§SI')) && (vars.get('§FS_ACC_SX_DX') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT1') != vars.get('§SI')) && (vars.get('§FS_SCA_MON_POS1') != vars.get('§SI')))) {
