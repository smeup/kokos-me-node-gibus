...
export const REG0004705: Rule = (iv) => {
    ...
    // #7
    // COND:
    // ( §FS_FAM2_ISOLA=§SI ) AND (§FS_ACC_PRI<>§SI ) AND (§FS_ACC_PRI_02<>§SI ) AND (§FS_ACC_CEN<>§SI ) AND (§FS_ACC_FIN<>§SI )    AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CF=#0
    // #8
    // COND:
    // ( §FS_FAM2_ISOLA=§SI ) AND (( §FS_ACC_PRI=§SI ) OR ( §FS_ACC_PRI_02=§SI )) AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CF=#0
    // #9
    // COND:
    // (§FS_FAM2_ISOLA=§SI ) AND ((§FS_ACC_CEN=§SI ) OR ( §FS_ACC_FIN=§SI )) AND (§TI_ACC_TWI='01') AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CF=#0
    // #10
    // COND:
    // (§FS_FAM2_ISOLA=§SI ) AND ((§FS_ACC_CEN=§SI ) OR (§FS_ACC_FIN=§SI )) AND (§TI_ACC_TWI='02') AND (§FS_ACC_DX_SX=§SI )
    // THEN:
    // *SET *CF=#0
    // #11
    // COND:
    ...
    // #13
    // COND:
    // ( §FS_FAM2_ADDF=§SI ) AND ( §FS_ACC_DX_SX=§SI ) AND (§FS_ACC_CEN=§SI ) AND (§TI_ACC_TWI='01' )
    // THEN:
    // *SET *CF=#0
    // #14
    // COND:
    // ( §FS_FAM2_ADDF=§SI ) AND ( §FS_ACC_DX_SX=§SI ) AND (§FS_ACC_CEN=§SI ) AND (§TI_ACC_TWI='02')
    // THEN:
    // *SET *CF=#0
    // #15
    // COND:
    ...
    //#7
    if (vars.get('§FS_FAM2_ISOLA') == vars.get('§SI') && vars.get('§FS_ACC_PRI') != vars.get('§SI') && vars.get('§FS_ACC_PRI_02') != vars.get('§SI') && vars.get('§FS_ACC_CEN') != vars.get('§SI') && vars.get('§FS_ACC_FIN') != vars.get('§SI') && vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) {
        vars.setCF(0);
    }
    
    //#8
    if (vars.get('§FS_FAM2_ISOLA') == vars.get('§SI') && (vars.get('§FS_ACC_PRI') == vars.get('§SI') || vars.get('§FS_ACC_PRI_02') == vars.get('§SI')) && vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) {
        vars.setCF(0);
    }
    
    //#9
    if (vars.get('§FS_FAM2_ISOLA') == vars.get('§SI') && (vars.get('§FS_ACC_CEN') == vars.get('§SI') || vars.get('§FS_ACC_FIN') == vars.get('§SI')) && vars.get('§TI_ACC_TWI') == '01' && vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) {
        vars.setCF(0);
    }
    
    //#10
    if (vars.get('§FS_FAM2_ISOLA') == vars.get('§SI') && (vars.get('§FS_ACC_CEN') == vars.get('§SI') || vars.get('§FS_ACC_FIN') == vars.get('§SI')) && vars.get('§TI_ACC_TWI') == '02' && vars.get('§FS_ACC_DX_SX') == vars.get('§SI')) {
        vars.setCF(0);
    }
    ...
    //#13
    if (vars.get('§FS_FAM2_ADDF') == vars.get('§SI') && vars.get('§FS_ACC_DX_SX') == vars.get('§SI') && vars.get('§FS_ACC_CEN') == vars.get('§SI') && vars.get('§TI_ACC_TWI') == '01') {
        vars.setCF(0);
    }
    
    //#14
    if (vars.get('§FS_FAM2_ADDF') == vars.get('§SI') && vars.get('§FS_ACC_DX_SX') == vars.get('§SI') && vars.get('§FS_ACC_CEN') == vars.get('§SI') && vars.get('§TI_ACC_TWI') == '02') {
        vars.setCF(0);
    }
