...
export const REG0005647: Rule = (iv) => {
    ...
    // #8
    // COND:
    // ( §FS_ADDL_SX=§SI ) AND ( §FS_ACC_LAT=§SI ) AND (§FS_ACC_FIN=§SI ) AND (( §FS_SCA_MON_ANT2<>§SI ) OR (§FS_SCA_MON_POS2<>§SI))
    // THEN:
    // *SET *CF=#1
    // #9
    // COND:
    // (§FS_ADDL_SX=§SI ) AND (§FS_ACC_LAT=§SI ) AND (§FS_ACC_FIN=§SI ) AND ((§FS_SCA_MON_ANT2<>§SI ) AND ( §FS_SCA_MON_POS2<>§SI))
    // THEN:
    // *SET *CF=#2
    // #10
    // COND:
    ...
    //#8
    if ((vars.get('§FS_ADDL_SX') == vars.get('§SI')) && (vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_FIN') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT2') != vars.get('§SI')) || (vars.get('§FS_SCA_MON_POS2') != vars.get('§SI')))) {
        vars.setCF(1);
    }
    //#9
    if ((vars.get('§FS_ADDL_SX') == vars.get('§SI')) && (vars.get('§FS_ACC_LAT') == vars.get('§SI')) && (vars.get('§FS_ACC_FIN') == vars.get('§SI')) && ((vars.get('§FS_SCA_MON_ANT2') != vars.get('§SI')) && (vars.get('§FS_SCA_MON_POS2') != vars.get('§SI')))) {
